...
Detailed technical architecture and system design for the MLP Time Attendance system (v3.87).
...
*   **Hosted on:** Firebase Hosting (Production) + GitHub Pages (Mirror via GitHub Actions).
*   **UI Libraries:** 
