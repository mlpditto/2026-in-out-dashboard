...
**Current Version**: `v3.67 - Fair Auto Roster` | **Last Updated**: 2026-09-16
...
- **แท็บสรุป & OT**: ดูจำนวนเวรรายคน และแท็บ OT ที่รวมเฉพาะผู้มีเวรควบ (ช-บ / บ-ด / Day+Night) ซึ่งระบบตรวจจับจากข้อความ `shiftDetail` ของเวรเดิม (ยังไม่มีปุ่มเวรควบใน Palette)
