...
**Current Version**: `v3.49 - Separate History & Edit Support` | **Last Updated**: 2026-02-24
...
- เมื่ออนุมัติ: สร้าง schedule อัตโนมัติพร้อม emoji และ **ซิงค์รายละเอียดล่าสุดที่แอดมินแก้ไข** (เหตุผล, ช่วงวันที่ลา, ลิงก์แนบ) ลงในตารางเวรให้ทันที
