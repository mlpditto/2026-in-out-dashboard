...
**Current Version**: `v3.30 - Stable` | **Last Updated**: 2026-02-21
...
### v3.30 — 2026-02-21
- 🔒 **Schedule-Lock System**: บังคับพนักงานส่งเวรปฏิบัติงานก่อนถึงจะกด Clock In/Out ได้ เพื่อความถูกต้องของข้อมูลปฏิทิน
- ⚡ **Auto-Approve Schedules**: ระบบอนุมัติการแจ้งเวร (Work Schedule) อัตโนมัติทันที พร้อมลงตารางรายวันให้เสร็จสรรพ
- ⚠️ **Late Detection System**: ระบบตรวจจับการมาสายอัตโนมัติ (เกิน 5 นาทีจากเวลาในเวร)
- 📝 **Reason for Lateness**: บังคับพนักงานระบุเหตุผลเมื่อมาสาย โดยข้อมูลจะไปแสดงผลที่หน้า Admin พร้อมจำนวนนาทีที่สาย
- 🎨 **Late Badges**: เพิ่มสถานะ "สาย" พร้อมปุ่มคลิกดูเหตุผลในหน้า Dashboard Admin
