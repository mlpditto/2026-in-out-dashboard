# 🚀 Features - MLP Time Attendance Dashboard (v3.83)
...
*   🪄 **Auto Roster Fill:** กำหนดจำนวนคนต่อกะแยกวันธรรมดา/วันหยุด แล้วให้ระบบกระจายเวรแบบหมุนเวียนอัตโนมัติ — คนหนึ่งคนได้ไม่เกินวันละ 1 กะ, ข้ามคนที่มีวันลาอนุมัติแล้ว และถ้าคนไม่พอจะลดจำนวนแต่ละกะตามสัดส่วนพร้อมแจ้งเตือน
