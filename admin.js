...
async function showDayAttendanceDetail(dateStr) {
    ...
    try {
        ...
        let html = `
        <div class="mb-3 text-start sticky-top bg-white pt-2 pb-2" style="z-index: 10; border-bottom: 1px solid #f0f0f0;">
            <button onclick="window.copyAttendanceSummaryByDate('${dateStr}')" class="btn btn-primary btn-sm rounded-pill shadow-sm">
        ...
        Swal.update({
            html: html,
            showConfirmButton: false // Hide default confirm button as we have our own
        });
